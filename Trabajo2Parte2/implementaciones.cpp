...
void crearCliente(Lista& lista){
 /*
  * Nombre de la función: crearCliente.
  * Tipo de función: void.
  * Parámetros: lista de tipo lista.
  * Dato de retorno: No retorna datos
  * Descripción de la función: La función crearCliente() pregunta al usuario sus datos personales, para la contratación de planes, los almacena en el documento de texto y los inserta en una lista.
  */

cliente nuevoCliente; // Se crea al nuevo cliente para tomar sus datos.
...
scanf("%s %s", nuevoCliente.nombre, nuevoCliente.apellido);
fprintf(registrar, nuevoCliente.nombre);
fprintf(registrar, " ");
fprintf(registrar, nuevoCliente.apellido);
fprintf(registrar, "|");

printf("Indique su RUT\n");
scanf("%s", nuevoCliente.rut);
fprintf(registrar, nuevoCliente.rut);
fprintf(registrar, "|");
printf("Indique el numero de celular al que se cargara el plan\n");
scanf("%s", nuevoCliente.celular);
fprintf(registrar, nuevoCliente.celular);
fprintf(registrar, "|");
printf("Indique su email\n");
scanf("%s", nuevoCliente.email);
fprintf(registrar, nuevoCliente.email);
fprintf(registrar, "|");
printf("Indique su direccion de domicilio (sin espacios al escribir la direccion)\n");
scanf("%s", nuevoCliente.direccion);
fprintf(registrar, nuevoCliente.direccion);
fprintf(registrar, "|");
